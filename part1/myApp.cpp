//File which contains the application. Example Invocation: ./derekLED on <-- Will turn on LED. Can use command on off flash or status

#include "derek_LED.h"

int main(int argc, char* argv[]){
   if(argc!=2){
	cout << "Usage is derekLED <command>" << endl;
